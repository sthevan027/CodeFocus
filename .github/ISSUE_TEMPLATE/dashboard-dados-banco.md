---
name: Dashboard com dados reais do banco
about: Integrar o Dashboard ao Supabase para exibir estatísticas reais em vez de localStorage
title: '[Feature] Dashboard deve consumir dados reais do banco (Supabase)'
labels: 'enhancement, dashboard, backend'
assignees: ''
---

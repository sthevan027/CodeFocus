...
const LoginScreen = ({ onGoToRegister }) => {
  ...
  const handleGitHubLogin = async () => {
    ...
    setError('Login com GitHub em breve!');
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-teal-900 flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-10 border border-white/10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Entre para continuar sua jornada produtiva</p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-gray-900/80 text-gray-400">ou continue com</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 text-white font-medium py-3 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
            disabled={loading}
          >
